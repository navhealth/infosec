# 24. HIPAA Mappings to CareJourney Controls

Below is a list of HIPAA Safeguards and Requirements and the CareJourney controls in place to meet those.

| **Administrative Controls** HIPAA Rule | CareJourney Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | CareJourney Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | CareJourney Control
---------------- | ----------------
